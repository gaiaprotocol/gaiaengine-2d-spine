import { AtlasAttachmentLoader, SkeletonBinary, SkeletonJson, Skin as SpineSkin, Spine as PixiSpine, SpineTexture, TextureAtlas, } from "@esotericsoftware/spine-pixi-v8";
...
export default class Spine extends GameObject {
    ...
    async load() {
        ...
        if ((!texture && !textures) || this.isRemoved())
            return;
